...
namespace DialoguerEditor
{
    public class DialogueEditorGUI : MonoBehaviour
    {
		...
		*/
        ...
        public static string drawTextField(Rect rect, string text, GUIStyle style)
        {
            GUILayout.BeginArea(rect);
            var ret = EditorGUILayout.TextField(text, style, GUILayout.ExpandWidth(true), GUILayout.ExpandHeight(true));
            GUILayout.EndArea();
        ...
        {
            GUILayout.BeginArea(rect);
            var ret = EditorGUILayout.TextField(text, GUILayout.ExpandWidth(true), GUILayout.ExpandHeight(true));
            GUILayout.EndArea();

            return ret;
        }

        public static string drawTextArea(Rect rect, string text)
        {
            GUILayout.BeginArea(rect);
            var ret = EditorGUILayout.TextArea(text, GUILayout.ExpandWidth(true), GUILayout.ExpandHeight(true));
            GUILayout.EndArea();
